...
<template>
    <vscode-dropdown title="Select code display mode" :value="settings.displayMode"
    ...
    <div class="list">
        <callstack_view v-for="traceFrame in store.stackTrace.map((traceFrame, index) => ({ traceFrame, index }))"
            ...
            :traceFrame="traceFrame.traceFrame" @open-file="fn.showFile" @set-stack-frame-id="fn.setFrameId"
